...
router.post('/', auth, multer,stuffCtrl.createThing); // Use the controller for creating a Thing
router.get('/:id', auth, stuffCtrl.getOneThing); // Use the controller for getting one Thing
router.put('/:id', auth, multer, stuffCtrl.modifyThing); // Use the controller for modifying a Thing  
